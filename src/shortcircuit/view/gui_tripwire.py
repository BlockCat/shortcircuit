...
class Ui_TripwireDialog(object):
    def setupUi(self, TripwireDialog):
        ...
        self.gridLayout.addWidget(self.lineEdit_user, 2, 3, 1, 1)
        self.lineEdit_url = QtGui.QLineEdit(TripwireDialog)
        self.lineEdit_url.setObjectName("lineEdit_url")
        self.gridLayout.addWidget(self.lineEdit_url, 1, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.lineEdit_pass, 3, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_evescout_logo, 5, 1, 2, 1)
