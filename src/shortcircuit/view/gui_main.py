...
#
# Created: Wed Mar 01 13:13:43 2017
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/images/bridge_icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton_bridge.setIcon(icon4)
        self.pushButton_bridge.setIconSize(QtCore.QSize(24, 24))
        self.pushButton_bridge.setObjectName("pushButton_bridge")
        self.gridLayout_4.addWidget(self.pushButton_bridge, 3, 0, 1, 1)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/images/config_icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton_trip_config.setIcon(icon5)
        ...
        self.pushButton_crest_config.setIcon(icon5)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.pushButton_bridge_conf.sizePolicy().hasHeightForWidth())
        self.pushButton_bridge_conf.setSizePolicy(sizePolicy)
        self.pushButton_bridge_conf.setIcon(icon5)
        self.pushButton_bridge_conf.setObjectName("pushButton_bridge_conf")
        self.gridLayout_4.addWidget(self.pushButton_bridge_conf, 3, 1, 1, 1)
        self.pushButton_siggy_get = QtGui.QPushButton(self.groupBox__options)
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/images/siggy_logo.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton_siggy_get.setIcon(icon6)
        self.pushButton_siggy_get.setIconSize(QtCore.QSize(24, 24))
        self.pushButton_siggy_get.setCheckable(False)
        self.pushButton_siggy_get.setObjectName("pushButton_siggy_get")
        self.gridLayout_4.addWidget(self.pushButton_siggy_get, 2, 0, 1, 1)
        self.pushButton_siggy_config = QtGui.QPushButton(self.groupBox__options)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Maximum, QtGui.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.pushButton_siggy_config.sizePolicy().hasHeightForWidth())
        self.pushButton_siggy_config.setSizePolicy(sizePolicy)
        self.pushButton_siggy_config.setIcon(icon5)
        self.pushButton_siggy_config.setObjectName("pushButton_siggy_config")
        self.gridLayout_4.addWidget(self.pushButton_siggy_config, 2, 1, 1, 1)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/images/delete_icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton_avoid_clear.setIcon(icon7)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_siggy_get.setText(QtGui.QApplication.translate("MainWindow", "Get Siggy chain", None, QtGui.QApplication.UnicodeUTF8))
        self.pushButton_siggy_config.setText(QtGui.QApplication.translate("MainWindow", "Siggy", None, QtGui.QApplication.UnicodeUTF8))
